...
**Kanonický seznam (sjednoceno podle „Formy financování vs zajištění“):**
- Zápůjčka / úvěr
...
- Prodej projektu (volitelné; pokud nechceme v první verzi, v UI vypnout)
...
- Kapacita tiketu: maximální počet **aktivních** rezervací na tiket (výchozí 3; nastavuje admin; návrh může dát developer i obchodník u leadu).
- **Aktivní rezervace =** podepsaná oběma stranami (developer + investor) → identity jsou odemknuty.
- Pravidlo konkurence (výchozí):
  - jakmile na tiketu existuje **alespoň jedna aktivní rezervace**, tiket je „zamčený“ pro ostatní obchodníky,
  - další rezervace (až do kapacity) může vytvářet pouze **stejný obchodník**, který má na tiketu aktivní rezervaci,
  - ostatní obchodníci musí čekat, než se tiket uvolní (tj. na tiketu nebude žádná aktivní rezervace).
...
- aktivní rezervace = podepsaná oběma stranami (developer + investor).

**Pravidlo konkurence (výchozí):**
- pokud na tiketu není žádná aktivní rezervace, může kterýkoliv obchodník vytvořit rezervaci (a zahájit podpisní proces).
- jakmile se na tiketu stane první rezervace **aktivní**, tiket se „zamkne“ pro ostatní obchodníky:
  - aktivní rezervace na jednom tiketu mohou být v jednu chvíli pouze od **jednoho obchodníka**,
  - stejný obchodník může vytvořit další aktivní rezervace až do kapacity tiketu (1–3),
  - ostatní obchodníci musí čekat, než se tiket uvolní (tj. nezůstane na něm žádná aktivní rezervace).
...
| Maximální počet aktivních rezervací na tiket (celkem) | integer | ano | administrátor | administrátor, developer | Výchozí 3; aktivní = podepsaná oběma stranami; obchodník vidí „dostupnost“ |
| Pravidlo konkurence na tiketu | enum | ano | administrátor | administrátor, developer | Výchozí: aktivní rezervace na tiketu mohou být současně pouze od 1 obchodníka (tiket se „zamkne“ po první aktivaci) |
