...
2) Systém ověří kapacity a limity:
   ...
   - dostupnost tiketu (volná kapacita rezervací na tiketu),
   - pokud je kapacita plná, nelze vytvořit další rezervaci (obchodník čeká na uvolnění).
...
5) Developer zvolí způsob podpisu:
   - **Elektronický podpis (výchozí):** systém odešle výzvu k podpisu oprávněné osobě developera.
   - **Fyzický podpis developera:** developer si stáhne PDF rezervační smlouvy, podepíše mimo platformu a nahraje scan do rezervace.
   - Platforma obsah scanu neověřuje; slouží jako evidence a pro audit.
   - Lhůta pro podpis developera je **48 hodin** (výchozí; administrátor může měnit i prodlužovat).
...
- Kapacita tiketu: maximální počet **souběžně obsazených** rezervací na tiket (výchozí 3; nastavuje admin; návrh může dát developer i obchodník u leadu).
- **Obsazená rezervace =** rezervace, která ještě není ukončená (tj. od vytvoření rezervace a odeslání k podpisu až do ukončení; zahrnuje čekání na podpisy, aktivní rezervaci i jednání).
- Pravidlo konkurence (výchozí):
  - tiket se po první aktivaci **nezamyká** pro ostatní obchodníky,
  - platí princip „kdo dřív obsadí volné sloty, ten má přednost“ (do kapacity),
  - další obchodníci mohou vytvořit rezervaci, dokud je na tiketu volná kapacita,
  - pokud je kapacita plná, další rezervaci nelze vytvořit a obchodníci čekají na uvolnění slotu (expirace, zrušení, ukončení neúspěšně).
...
- Doba zveřejnění tiketu (publikační okno): výchozí 90 dní od zveřejnění (upravitelné adminem; lze prodlužovat).
...
**Slot (obchodník):**
- slot = kapacita obchodníka, kolik může mít **současně otevřených rezervací** (tj. rezervace v procesu, které ještě nejsou ukončené).
- rezervace zabírá slot od chvíle, kdy je vytvořena a je ve stavu „čeká na podpis“ / „rezervace aktivní“ / „jednání probíhá“.
- po ukončení rezervace (úspěšně/neúspěšně) se slot uvolní.

**Kapacita na tiketu:**
- každý tiket má parametr „kapacita rezervací na tiketu“ (výchozí 3; nastavuje administrátor).
- kapacita = maximální počet **souběžně obsazených** rezervací na tiketu (včetně čekání na podpis i aktivních rezervací).
- rezervace obsazuje 1 jednotku kapacity od vytvoření (odeslání k podpisu) až do ukončení / expirace.

**Pravidlo konkurence (výchozí):**
- tiket se po první aktivaci **nezamyká** pro ostatní obchodníky.
- volné rezervace (sloty) jsou k dispozici pro všechny obchodníky – dokud je kapacita volná.
- kdo obsadí sloty dříve, má přednost; pokud jeden obchodník obsadí všechny sloty, ostatní musí čekat na uvolnění.
- po uvolnění slotu jej může obsadit jakýkoli obchodník (stejný i jiný).

**Administrátor může** kapacitu i pravidlo konkurence upravit per tiket (s auditní stopou). Developer i obchodník mohou kapacitu navrhnout při zadání (lead / projekt).
...
- Výchozí doba zveřejnění tiketu je **90 dní od zveřejnění** (administrátor může upravit, prodlužovat i re-publikovat).
...
**Rozpor:**
- dřívější verze podkladů popisovala, že po první aktivaci rezervace se tiket „zamkne“ pro ostatní obchodníky
- aktuální obchodní rozhodnutí je ale model „volných slotů“ (kapacita), kde mohou rezervace vytvářet různí obchodníci do naplnění kapacity

**Kanonické rozhodnutí (aktuální):**
- tiket se po první aktivaci **nezamyká** na jednoho obchodníka
- tiket má kapacitu (výchozí 3) a rezervace jsou „kdo dřív obsadí slot, ten ho má“
- pokud rezervace expiruje nebo je ukončena neúspěšně, slot se uvolní a může ho obsadit jiný obchodník
...
| Kapacita rezervací na tiketu (celkem) | integer | ano | administrátor | administrátor, developer | Výchozí 3; počítá se každá otevřená rezervace (čeká na podpis, aktivní, jednání); obchodník vidí „dostupnost“ |
| Pravidlo konkurence na tiketu | enum | ano | administrátor | administrátor, developer | Výchozí: „sdílené sloty“ – tiket se po první aktivaci nezamyká; rezervace mohou zakládat různí obchodníci do naplnění kapacity |
...
- Default pravidlo konkurence na tiketu: „exkluzivní aktivní rezervace pro 1 obchodníka“
